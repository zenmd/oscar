...
<html>
	...
	<br/>	
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0C0C0">
			...
			<c:forEach var="msg" items="${ActiveFacilityMessages}" varStatus="status">
				...
				<tr style="<%=style %>" bgcolor="<%=bgcolor %>">
					<td valign="middle">
						<a href="FacilityMessage.do?method=edit&id=<c:out value="${msg.id}"/>"><img border="0" src="images/edit.jpg"/></a>
					</td>
