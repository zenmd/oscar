...
<table width="100%" border="0"  cellpadding="0" cellspacing="1" bgcolor="#C0C0C0">
	...
	<tr>
		...
		<td bgcolor="#EEEEFF" ><html:text property="searchStartDate"/> to <html:text property="searchEndDate"/> (yyyy-mm-dd)</td>
	</tr>
	
	<tr>
		<td bgcolor="#EEEEFF">Program:</td>
		<td bgcolor="#EEEEFF">
			<html:select property="searchProgramId">
				<html:option value="0">&nbsp;</html:option>
				<html:options collection="program_domain" property="id" labelProperty="name"/>
			</html:select>
		</td>
	</tr>
	...
	<tr>
		<td bgcolor="#EEEEFF" colspan="2"><html:submit onclick="this.form.method.value='search'"/></td>
	</tr>
</table>
...
<tr>
<td align="left">
<span style="text-decoration: underline;cursor:pointer;color: blue" onclick="document.caseManagementViewForm.note_view.value='summary';document.caseManagementViewForm.method.value='search';document.caseManagementViewForm.submit(); return false;" >Summary</span>
&nbsp;|&nbsp;
<span style="text-decoration: underline;cursor:pointer;color: blue" onclick="document.caseManagementViewForm.note_view.value='detailed';document.caseManagementViewForm.method.value='search';document.caseManagementViewForm.submit();return false;">Detailed</span>
</td>
<td align="right"> 
Sort:
...
<c:choose>
<c:when test="${sessionScope.caseManagementViewForm.note_view!='detailed'}">
