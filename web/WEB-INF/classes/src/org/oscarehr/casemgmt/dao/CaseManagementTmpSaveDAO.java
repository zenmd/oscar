...
public class CaseManagementTmpSaveDAO extends HibernateDaoSupport {
    ...
    public void delete(String providerNo, Integer demographicNo, Integer programId) {
    ...
    public CaseManagementTmpSave load(String providerNo, Integer demographicNo, Integer programId) {
    ...
    public CaseManagementTmpSave load(String providerNo, Integer demographicNo, Integer programId, Date date) {
