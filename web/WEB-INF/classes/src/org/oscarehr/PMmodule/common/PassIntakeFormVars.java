...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    demographicNo = Utility.escapeNull(request.getParameter("demographicNo"));
    ...
    clientFirstName = Utility.escapeNull(request.getParameter("clientFirstName"));
    ...
    clientSurname = Utility.escapeNull(request.getParameter("clientSurname"));
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if(searchForClient == null)
	{
    	...
    	searchForClient = Utility.escapeNull(searchForClient);
    }
    else
    {
...
*/
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    viewIntakeA = Utility.escapeNull(request.getParameter("viewIntakeA"));
    ...
    viewIntakeB = Utility.escapeNull(request.getParameter("viewIntakeB"));
    ...
    viewIntakeC = Utility.escapeNull(request.getParameter("viewIntakeC"));
    ...
    formIntakeBLock = Utility.escapeNull(request.getParameter("formIntakeBLock"));
    ...
    actionType = Utility.escapeNull(request.getParameter("actionType"));
    if(actionType == null  ||  actionType.equals(""))
    {
    	if(request.getAttribute("actionType") != null)
    	{
    		actionType = Utility.escapeNull((String)request.getAttribute("actionType"));
    	}
    }
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    startDate = Utility.escapeNull(request.getParameter("startDate"));
    if(startDate == null  ||  startDate.equals(""))
    {
    	if(request.getAttribute("startDate") != null)
    	{
    		startDate = Utility.escapeNull((String)request.getAttribute("startDate"));
    	}
    }
    
    endDate = Utility.escapeNull(request.getParameter("endDate"));
    if(endDate == null  ||  endDate.equals(""))
    {
    	if(request.getAttribute("endDate") != null)
    	{
    		endDate = Utility.escapeNull((String)request.getAttribute("endDate"));
    	}
    }
