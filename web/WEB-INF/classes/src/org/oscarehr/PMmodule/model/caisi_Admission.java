 ...
 */
public class caisi_Admission implements Serializable,Cloneable {
	 ...
	 */
	public caisi_Admission (Integer id) {
		this.setId(id);
	}
	 ...
	 */
	public caisi_Admission(Integer id, String providerNo, Integer clientId, Integer programId) {
		this.setId(id);
