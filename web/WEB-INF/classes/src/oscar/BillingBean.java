...
public class BillingBean extends Object implements Serializable{
  private ArrayList billingItems;
  ...
  public ArrayList getBillingItems() {
    return billingItems;
  }

  public synchronized void setBillingItems(ArrayList newBillingItems) {
  ...
  public BillingItemBean getBillingItem(int itemNo) {
    return (BillingItemBean)billingItems.get(itemNo);
  }
