...
<html:form action="/Tickler">
	...
	<tr>
		<td class="buttonBar"><html:link
			action="/PMmodule/Admin/UserManager.do?method=add"
	...
	<tr>
		...
		<table>
			<tr>
				...
				<td class="blueText"><quatro:datePickerTag
					property="filter.startDate" openerForm="ticklerForm" /></td>

				<td class="blueText">End: <quatro:datePickerTag
					property="filter.endDate" openerForm="ticklerForm" /></td>
