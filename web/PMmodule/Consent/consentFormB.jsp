...
<link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon" />
	...
	<script>
		...
		function submitConsent(form,optout) {
			...
			if(!optout) {
				document.consentForm.elements['goto'].value='';
			}
...
<body topmargin="20" leftmargin="10" onload="setCheckboxes()">
...
<table border="2" width="700" cellspacing="0" cellpadding="0">
	<tr>
		...
		<p><b><font color="blue">Part 1: Please give the client a copy of this consent form.  Please read the following to the client: </font></b></p>
		</td>
		</tr>
	<tr>
		<td width="100%">
		<p>The CAISI program was created to link many of the city's health and shelter service agencies
		 together so that people who are homeless can get better and faster services from them. 
		  The program wants people who are homeless to have control over their personal information and to 
		  have a better quality of life.  Your personal information is now stored on computers at the different 
		  places you get care.  With your permission, this information will be sent to other agencies 
		  when you seek services from them so that they can give you better care.  
		  The types of agencies are: </p>
		<li>Hospitals
		...
		Your information will be put together with the information from other people who are homeless to 
		improve the services offered, to do research, and to compile statistics for advocacy. </p>
				
		<p>Your care at <c:out value="${agency.name}"/> will not change by allowing agencies to send 
		information and work together through CAISI.  </p>
		 
		<p>You may withdraw permission to send information to other agencies at any time.
		 To withdraw, contact <c:out value="${agency.name}"/> or any other CAISI partner.  
		 Your care at <c:out value="${agency.name}"/> will not change if you withdraw permission.  
		 </p>
		 
		 <p>Any questions can be directed to <c:out value="${agency.name}"/> staff. </p>
		
		  <p>
		  You are allowed to ask for more information about CAISI and/or to talk to your worker or 
		  other people about CAISI.  You are allowed to make decisions based on this information.  
		  </p>
		...
		<html:form action="/PMmodule/Consent.do">
			...
			<input type="hidden" name="goto" value="/PMmodule/Consent/consentFormB2.jsp" />
	...
	<tr>
		...
		If one or more questions are answered incorrectly, do not proceed to part 3.  </font></b>
		</p>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="100%">
		<p><b><font color="blue">Part 3:  Please read the following prompts and record if the client
		 understands CAISI and if she/he chooses not to consent to CAISI.  
		 Do not read prompt if less than three correct answers were given for the questions in Part 2.  
		</font></b></p>
		</td>
	</tr>
	<tr>
		<td>
		<p><br>
		I, <b><U><c:out value="${clientName}"/></U></b>, understand the terms and conditions of the CAISI project above		
		</td>
	</tr>
	...
	<tr>
		<td>
			<input type="checkbox" id="readOptOutStatement"/>
				I have read the following to the client "You may withdraw permission to send information to other CAISI agencies thatare  caring for you at any time."				
		</td>
	</tr>	
	...
	<td>
	<br>
	<input type="button" value="Continue to Opt-Out Form" onclick="submitConsent(document.consentForm,true)" />	
