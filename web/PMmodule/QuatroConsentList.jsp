...
<table width="100%">	
	<tr>
		<td align="left" class="buttonBar2">
			...
			<security:oscarSec objectName="<%=KeyConstants.FUN_CLIENTCONSENT %>"   orgCd='<%=((Integer) request.getAttribute("currentIntakeProgramId")).toString()%>' rights="<%=KeyConstants.ACCESS_WRITE %>">
