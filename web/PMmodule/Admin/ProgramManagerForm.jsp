			...
			<div class="tabs">
				...
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						%>
										<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.general" rights="r">						
										<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
										</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Staff")) {
								%>
										<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.staff" rights="r">						
										<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
										</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Function User")) {
								%>
										<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.functionUser" rights="r">						
										<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
										</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Teams")) {
								%>
										<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.teams" rights="r">						
										<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
										</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Clients")) {
								%>
									<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.clients" rights="r">						
									<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
									</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Queue")) {
								%>
									<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.queue" rights="r">						
									<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
									</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Access")) {
								%>
									<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.access" rights="r">						
									<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
									</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Bed Check")) {
								%>
									<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.bedCheck" rights="r">						
									<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
									</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Client Status")) {
								%>
									<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.clientStatus" rights="r">						
									<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
									</security:oscarSec>
								<%} else if(ProgramManagerViewFormBean.tabs[i].equalsIgnoreCase("Service Restrictions")) {
								%>
									<security:oscarSec roleName="<%=roleName$%>" objectName="_pmm_editProgram.serviceRestrictions" rights="r">						
									<td><a href="javascript:void(0)" onclick="javascript:clickTab('<%=ProgramManagerViewFormBean.tabs[i] %>');return false;"><%=ProgramManagerViewFormBean.tabs[i]%></a></td>
									</security:oscarSec>
								<%} 
								%>
