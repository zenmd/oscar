...
<display:table class="simple" cellspacing="2" cellpadding="3" id="history" name="histories"  requestURI="/PMmodule/ClientHistory.do" >
	...
	<display:column property="actionDate" format="{0, date, yyyy/MM/dd kk:mm}" sortable="true" title="Action Date" />
	<display:column property="providerName" sortable="true" title="By User" />
	<display:column property="historyDate" format="{0, date, yyyy/MM/dd kk:mm}" sortable="true" title="By Date" />
</display:table>
</td></tr>
</table>
